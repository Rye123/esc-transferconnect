        ...
        <div className="view_item">
            ...
            <div className="vi_right">
                ...
                <div className="content">
                    ...
                    <p>Processing Time: {loyaltyProgram.processingTime}</p>
                    <p>Minimum Transfer Amount: {loyaltyProgram.minTransfer} {loyaltyProgram.currencyName}</p> {/* check if using points or miles*/}
                </div>
