...
const job_send = schedule.scheduleJob('0,30 * * * * *',() => SFTPClient.sendDailyTransfers(loyaltyPrograms));
const job_update = schedule.scheduleJob('15, 45 * * * * *',() => SFTPClient.updateDailyTransfers(loyaltyPrograms));
